...
internal enum Asset {
  ...
  internal static let amexIcon = ImageAsset(name: "amex.icon")
  ...
  internal static let dinersclubIcon = ImageAsset(name: "dinersclub.icon")
  internal static let discordIcon = ImageAsset(name: "discord.icon")
  internal static let discoverIcon = ImageAsset(name: "discover.icon")
  ...
  internal static let jcbIcon = ImageAsset(name: "jcb.icon")
  ...
  internal static let keeperIcon = ImageAsset(name: "keeper.icon")
  ...
  internal static let mastercardIcon = ImageAsset(name: "mastercard.icon")
  ...
  internal static let unionpayIcon = ImageAsset(name: "unionpay.icon")
  ...
  internal static let visaIcon = ImageAsset(name: "visa.icon")
