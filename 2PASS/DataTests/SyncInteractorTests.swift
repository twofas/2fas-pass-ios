...
private final class NoopItemsInteractor: ItemsInteracting {
    ...
    func loadTrustedKey(vaultID: VaultID) -> Bool { false }
    func encrypt(_ string: String, isSecureField: Bool, protectionLevel: ItemProtectionLevel, vaultID: VaultID) -> Data? { nil }
    func encryptData(_ data: Data, isSecureField: Bool, protectionLevel: ItemProtectionLevel, vaultID: VaultID) -> Data? { nil }
    func decrypt(_ data: Data, isSecureField: Bool, protectionLevel: ItemProtectionLevel, vaultID: VaultID) -> String? { nil }
    func decryptData(_ data: Data, isSecureField: Bool, protectionLevel: ItemProtectionLevel, vaultID: VaultID) -> Data? { nil }
    func decryptContent<T>(_ result: T.Type, from data: Data, protectionLevel: ItemProtectionLevel, vaultID: VaultID) -> T? where T: Decodable { nil }
...
private final class NoopTagInteractor: TagInteracting {
    ...
    func createTag(name: String, color: ItemTagColor, in vaultID: VaultID) {}
    func createTag(data: ItemTagData) {}
    func updateTag(data: ItemTagData) {}
    func deleteTag(tagID: ItemTagID, in vaultID: VaultID) {}
    func externalDeleteTag(tagID: ItemTagID) {}
    func listAllTags() -> [ItemTagData] { [] }
    func listAllEncryptedTags(in vaultID: VaultID) -> [ItemTagEncryptedData] { [] }
    ...
    func applyTagChangesToItems(_ itemIDs: [ItemID], tagsToAdd: Set<ItemTagID>, tagsToRemove: Set<ItemTagID>, in vaultID: VaultID) {}
