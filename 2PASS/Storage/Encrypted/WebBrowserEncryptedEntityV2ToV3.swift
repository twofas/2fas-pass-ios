//
//  WebBrowserEncryptedEntityV2ToV3.swift
//  2PASS
//
...
@objc
final class WebBrowserEncryptedEntityV2ToV3: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(
        ...
        Log("Migration - WebBrowserEncryptedEntity V2 → V3", module: .storage)
