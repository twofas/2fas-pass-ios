...
extension WebDAVStateInteractor: WebDAVStateInteracting {
    var canResyncAutomatically: Bool {
        ...
        case .error(let syncError):
            switch syncError {
            case .unauthorized, .forbidden, .schemaNotSupported, .notConfigured, .urlError, .sslError, .insecureRedirect, .methodNotAllowed, .limitDevicesReached, .passwordChanged: return false
